...
def _consolidated_fundamentals_block(canonical: str) -> dict[str, Any]:
    ...
    return {
        ...
        "other_income": record.get("other_income"),
        "total_income": record.get("total_income"),
        "total_expenses": record.get("total_expenses"),
        "employee_benefit_expense": record.get("employee_benefit_expense"),
        "finance_costs": record.get("finance_costs"),
        "depreciation_and_amortisation": record.get("depreciation_and_amortisation"),
