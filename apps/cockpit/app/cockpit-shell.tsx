...
import { Compass, LineChart, TrendingUp, Zap, Briefcase, LogOut, Factory, ShieldOff, Radio } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { href: "/live-trading", label: "Live Trading", icon: Radio, match: (path: string) => path.startsWith("/live-trading") },
